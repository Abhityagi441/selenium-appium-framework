...
public class LoginPage extends CommonLoginPage {
    ...
    @FindBy(xpath = "//span[@id='show-header-login']/a")
    private static WebElement singInButton;


    @FindBy(xpath = "//span[@class='hdr-menu-icn']/span")
    ...
    @FindBy(xpath = "//span[@class='dropdown']/a")
    ...
    public boolean logout() {
        ...
        if(commonFunctions.isElementDisplayed(hamburgerMenuButton, 10, "Hamburger menu on LH home page")) {
            commonFunctions.clickElementWithJS(hamburgerMenuButton, 10, "Hamburger menu on HT home page");
        }
        while(!commonFunctions.isElementDisplayed(userNameLabelAfterLogin, 20, "UserName") && count<=5) {
            commonFunctions.refreshPage();
            commonFunctions.waitForPageToLoad();
            commonFunctions.dummyWait(15);
            if(commonFunctions.isElementDisplayed(hamburgerMenuButton, 10, "Hamburger menu on LH home page")) {
                commonFunctions.clickElementWithJS(hamburgerMenuButton, 10, "Hamburger menu on LH home page");
            }
            count++;
        }
        commonFunctions.dummyWait(5);
        commonFunctions.waitForPageToLoad();
        commonFunctions.clickElementWithJS(userNameLabelAfterLogin, 5, "Display Name");
        //commonFunctions.isElementDisplayed(singOutButton,5,"sign out button");
        //commonFunctions.clickElementWithJS(singOutButton,10,"Sign out button");
        for (int i = 0; i < 5; i++) {
            if(!commonFunctions.isElementDisplayed(singOutButton, 10, "Sign out button")) {
                commonFunctions.clickElementWithJS(userNameLabelAfterLogin, 5, "Display Name");
            }
            commonFunctions.clickElement(singOutButton, 5, "Sign out button");
            if (!commonFunctions.isElementDisplayed(userNameLabelAfterLogin, 10, "User Name")) {
                break;
            }
        }
        ...
        commonFunctions.waitForPageToLoad();
        commonFunctions.dummyWait(5);
        logoutStatus = commonFunctions.isElementDisplayed(hamburgerMenuButton, 5, "Hamburger menu on HT home page");
        commonFunctions.clickElementWithJS(hamburgerMenuButton,10,"hamburger button");

        count =0;
        while(!commonFunctions.isElementDisplayed(singInButton, 20, "Sign In Button") && count<=5) {
        ...
        commonFunctions.dummyWait(5);
        logoutStatus &= commonFunctions.isElementDisplayed(singInButton, 10, "Sign-In Button");
        Utils.logStepInfo(true,"logoutStatus = " +logoutStatus);
        commonFunctions.clickElementWithJS(hamburgerCloseButton, 10, "Hamburger close button");
        return logoutStatus;
    }
...
//        preSetInitialization();
        ...
        commonFunctions.dummyWait(5);
        commonFunctions.isElementDisplayed(hamburgerMenuButton, 10, "Hamburger menu on LH home page");
        commonFunctions.clickElementWithJS(hamburgerMenuButton, 10, "Hamburger menu on LH home page");
        while(!commonFunctions.isElementDisplayed(singInButton, 30, "Sign In Button") && count<=5) {
            commonFunctions.refreshPage();
            commonFunctions.waitForPageToLoad();
            commonFunctions.dummyWait(15);
            commonFunctions.isElementDisplayed(hamburgerMenuButton, 10, "Hamburger menu on LH home page");
        ...
        commonFunctions.sendKeyBoolean(emailTextBoxMainSignInPage, email, 30, "Email/Phone Button");
        ...
        commonFunctions.clickElementWithJS(hamburgerMenuButton, 10, "Hamburger menu on HT home page");
        count=0;
        while(!commonFunctions.isElementDisplayed(userNameLabelAfterLogin, 30, "UserName") && count<=5) {
            commonFunctions.refreshPage();
            commonFunctions.waitForPageToLoad();
            commonFunctions.dummyWait(15);
            commonFunctions.isElementDisplayed(hamburgerMenuButton, 10, "Hamburger menu on LH home page");
    ...
    public boolean loginWithGoogleAccount(String email, String password, String expectedUserName, String backupCodeWeb, String backupCodeAndroidWeb, String backupCodeIosWeb){
        ...
        commonFunctions.clickElementWithJS(singInButton, 30, "Sign In Button");
        commonFunctions.clickElementWithJS(continueWithGoogleButton, 25, "continue with Google button");
        commonFunctions.sendKeyBoolean(emailOrPhoneGmailSignInPage, email, 20, "email or phone box");
        commonFunctions.clickElementWithJS(nextButtonGmailSignInPage, 10, "next button");
        commonFunctions.sendKeyBoolean(passwordTextBoxGmailSignInPage, password, 10, "password box");
        commonFunctions.clickElementWithJS(nextButtonGmailPasswordPage, 15, "next button");
        if(commonFunctions.isElementDisplayed(tryWithAnotherWayLink, 10)){
            commonFunctions.clickElementWithJS(tryWithAnotherWayLink, 10, "Try With Another Way Link");
            commonFunctions.clickElementWithJS(backupCodeLink, 10, "Backup Code Link");
            commonFunctions.sendKeyBoolean(backupInput, backupCodeIosWeb, 10, "Backup box");
            commonFunctions.clickElementWithJS(backupNextBtn, 15, "next button");
        }
