...
public class HomePage extends CommonHomePage {
    ...
    private static WebElement weatherBtn;
	...
	public boolean checkExistingOptionVisible() {
        ...
        boolean isLeftNavigationDisplayed;
        commonFunctions.scrollDownToBottom();
        commonFunctions.isElementDisplayed(viewAll, 15, "View All");
        Utils.logStepInfo(true, "Loading is working Successfully");
        commonFunctions.scrollUpToTop();
        commonFunctions.dummyWait(2);
        commonFunctions.clickElementWithJS(hamburger, 20, "Hamburger Option");
        isLeftNavigationDisplayed = commonFunctions.isElementDisplayed(sideNavigation, 15, "Search bar");
        commonFunctions.clickElement(closeOption, 20, "Close Option");
        return isLeftNavigationDisplayed;
    }
    ...
    public boolean checkExploreOptionOpening() {
        ...
        isExploreOptionDisplayed = commonFunctions.isElementDisplayed(weatherBtn,10,"weatherBtn");
