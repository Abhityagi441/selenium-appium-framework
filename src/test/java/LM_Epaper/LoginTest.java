...
public class LoginTest {
    ...
    public void initialization(){
        globalVars = DriverController.setup(Constants.LM_E_PAPER);
    }
    ...
    public void verifyLoginWithGoogle() {
        ...
        String expectedUserName=params[2].toUpperCase();
    ...
    public void verifyLoginWithMobileOTP() {
        ...
        isStepTrue = loginPage.loginWithOTP(email, apiURI, mode,auth, expectedUserName);
    ...
    public void verifyLoginWithEmailOTP(){
        ...
        String auth = params[2];
        String mode = params[3];
        String expectedUserName = params[4].toUpperCase();
        isStepTrue = loginPage.loginWithOTP(email, apiURI, mode,auth, expectedUserName);
        Assert.assertTrue(isStepTrue, "Login with OTP failed");
    ...
    @Author(name = "Ishank Khatri")
    @Test
    public void verifyLoginWithMobileAndPassword() throws InterruptedException {
        boolean isStepTrue;
