...
public class NewsLettersPage extends CommonNewsLettersPage {
    ...
    public boolean checkMintTechOnNewslettersPageForSubscriberOnlyNewsletters() {
        commonFunctions.navigateToPageThroughExploremenu(explore,explorenewsletter,"newsletters");
        commonFunctions.isElementDisplayed(getMintTechDaysOfWeeks, 10, "Verify the days must be written on top i.e Thursday");
        commonFunctions.isElementDisplayed(getMintTechLogo, 10, "Logo should be displayed");
        commonFunctions.isElementDisplayed(getPremiumTagOnMintTech);
        commonFunctions.scrollToElementView(getMintTechTitle, 10, "Verify the title of the newsletter.");
        commonFunctions.isElementDisplayed(getMintTechTitle, 10, "Verify the title of the newsletter.");commonFunctions.isElementDisplayed(getMintTechDescr, 10, "Verify the description of the newsletter. ");
        commonFunctions.isElementDisplayed(getMintTechPreview, 10, ".Verify the preview link.");
        commonFunctions.isElementDisplayed(getMintTechPlusIcon,10,"Verify the subscribe CTA.button");
