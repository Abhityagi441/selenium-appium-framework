...
public class AdvertisementPage extends CommonAdvertisementPage {
        ...
        @FindBy(xpath="(//div[contains(@class,'listtostory')])[5]")
        private static WebElement storyAfterAd;
        ...
        @FindBy(xpath="//div[contains(@class,'listingNew')][5]")
        private static WebElement storyBeforeAdNews;
        @FindBy(xpath="//div[contains(@class,'listingNew')][8]")
        private static WebElement storyAfterAdNews;

        @FindBy(xpath="//div[@id='subscribeAd']")
        private static WebElement adNews;
        ...
        public boolean checkAdsOnSubscribedHomePage(){
                ...
                commonFunctions.scrollToElementView(mintSnapView,10,"Scrolled to snap view carousal");
                commonFunctions.scrollToElement(storyAfterAd,10,"subscriber ad container");
                commonFunctions.isElementDisplayed(storyAfterAd,10,"Story after Ad");
                boolean subscriberAdDisplayed= commonFunctions.isElementDisplayed(storyPageSubscriberAd,10,"subscriber WAP ad unit");
                //boolean subscriberAdDisplayed=driver.findElements(By.xpath("//div[contains(@id,'google_ads_iframe_/1055314/LM_MF_WAP_subscription_300x250')]")).size()>0;
        ...
        public boolean checkAdsOnSubscribedStoryPage(){
                ...
                boolean checkAdunit=commonFunctions.scrollToElementView(storyPageSubscriberAd,10,"Subscriber Ad container");



                if(mastheadAdDisplayed   && checkAdunit){
                        return true;
                }
                else{return false;}
        }
        ...
        public boolean checkAdsOnSubscribedlistingPage(String pageName){
                ...
                if(pageName.equalsIgnoreCase("News")){
                        commonFunctions.scrollToElementView(storyAfterAdNews,10,"story number 8");
                        commonFunctions.scrollToElementView(storyBeforeAdNews,10,"story number 6");
                        checkAdunit= commonFunctions.isElementDisplayed (adNews,15,"subscriber ad unit");
                }
                else {
                        commonFunctions.scrollToElementView(storyBeforeAd, 10, "story number 9 ");
                        checkAdunit = commonFunctions.scrollToElementView(subscriberAdContainer, 15, "subscriber ad unit");
                }
