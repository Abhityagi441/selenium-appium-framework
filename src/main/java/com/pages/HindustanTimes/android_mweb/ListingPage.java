...
public class ListingPage extends CommonListingPage {
    ...
    @FindBy(xpath="(//a[@href='/entertainment']/em)[1]")
    ...
    public boolean checkRedirectionToTopOfThePage2OfSameSection() {
        ...
        if(pageNum2.equalsIgnoreCase("PAGE 2")){
    ...
    public boolean checkPaginationWorkingOnListingPages() {
        ...
        boolean hamburgerMenu= commonFunctions.clickElementWithJS(exploreButton, 15, "Explore");
        boolean checkEntertainmentSection= commonFunctions.clickElementWithJS(entertainmentOption, 20, "entertainmentOption");
        boolean checkRedirection= checkRedirectionToEntertainmentSection();
        commonFunctions.scrollToBottomWorked();
        boolean scrollBottomOfPage= commonFunctions.scrollToElementView(scrollDownToListPagination, 20, "List Pagination");
