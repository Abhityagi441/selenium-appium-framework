...
public class SocialSharingPage extends CommonSocialSharingPage {
    ...
    private static WebElement clickopenFullStory;
    ...
    private static WebElement twitterSharingOption;

    @FindBy(xpath = "//amp-social-share[@type='facebook']")
    private static WebElement facebookSharingOption;

    @FindBy(xpath = "//amp-social-share[@type='whatsapp']")
    private static WebElement whatsappSharingOption;
    ...
    public boolean clickOnReadFullStory() {
        ...
        try {
            isClickOnReadFullStory=commonFunctions.scrollToElementViewAndClick(clickopenFullStory, 20, "openFullStory");
            String currentURL = commonFunctions.getCurrentURL("URL","getCurrentURL successful");
            if(!currentURL.isEmpty()&& currentURL.contains(globalVars.getAmpUrl())) {
    ...
    public boolean checkSocialSharingFunctionality() {
        boolean readFullStory = clickOnReadFullStory();
        boolean sharingTwitter = checkSharingStoryOnSocialMedia(twitterSharingOption, "twitterSharingOption", "twitter.com"); 
        boolean sharingWhatsapp = checkSharingStoryOnSocialMedia(whatsappSharingOption, "whatsappSharingOption", "whatsapp.com");
        boolean sharingFacebook = checkSharingStoryOnSocialMedia(facebookSharingOption, "facebookSharingOption", "facebook.com");

        return readFullStory  && sharingTwitter  && sharingWhatsapp;
    }
