...
public class VideoPage extends CommonVideoPage {
    ...
    @FindBy(xpath = "//div[@class='ytp-player-content ytp-iv-player-content']")
    ...
    public boolean checkVideoDetailPage() {
        ...
        String storyPageTitle = commonFunctions.getElementText(photoPageMainTitles.get(0), 10);
        commonFunctions.scrollDownToElement(photoPageMainTitles.get(0));
        commonFunctions.clickElementWithJS(photoPageMainTitles.get(0), 10, storyPageTitle);
