...
public class AdvertisementPage extends CommonAdvertisementPage {
        ...
        @FindBy(xpath="(//div[contains(@class,'listtostory')])[4]")
        ...
        public boolean checkAdsOnSubscribedHomePage(){
               // commonFunctions.clickElement(closeMyAccount,10,"Close my Account");
                ...
                boolean subscriberAdDisplayed= commonFunctions.isElementDisplayed(subscriberAdContainer,10,"subscriber WAP ad unit");
                ...
                System.out.println("Ad display= "+ subscriberAdDisplayed);
                commonFunctions.scrollToTop();
                if(mastheadAdDisplayed && rhsTopAdDisplayed ){
                        return true;
                }
                else{return false;}
        }
        ...
        public boolean checkAdsOnSubscribedlistingPage(String pageName){
               ...
               boolean checkAdunit=commonFunctions.scrollToElementView(subscriberAdContainer,10,"subscriber ad unit");
                commonFunctions.scrollToTop();
                if(mastheadAdDisplayed   && checkAdunit){
                        return true;
                }
