...
public class MobileReviewsPage extends CommonMobileReviewsPage {
    private static WebDriver driver;
    private static GlobalVars globalVars;
    private static CommonFunctionsWeb commonFunctions;
    private static CommonFunctionWebHT commonFunctionsHt;

    public static MobileReviewsPage mobileReviewsPage;
    public static MobileReviewsPage getInstance(){
        if(mobileReviewsPage==null){
            mobileReviewsPage= new MobileReviewsPage();
        }
        return mobileReviewsPage;
    }

    public MobileReviewsPage() {
    ...
    @FindBy(xpath="((//li[@class='dropdownMenu'])[1]//li)[2]")
    private static WebElement mobileReviews;
    ...
    @Override
    public boolean checkBreadCrumbsOnMobileReviews() {
        commonFunctions.navigateToURL(globalVars.getURL());
        boolean latestNewsBol = breadCrumbNews(mobileReviews, "Home > Mobile > Mobile Reviews", "mobile/reviews");
        System.out.println(latestNewsBol);
        boolean newsUrl = commonFunctionsHt.checkCatogeriesNewsURL("mobile/reviews");
        System.out.println(newsUrl);
        boolean homepageLatest = commonFunctionsHt.redirectToHomepageFromCategories(redirectToHomepage, "mobile/reviews");
    ...
    public boolean breadCrumbNews(WebElement element, String home, String category) {
        ...
        Utils.logStepInfo(true, "Mobile reviews BreadCrumb available");
    ...
    @Override
    public boolean checkTopStoriesWidgetOnMobileReviews() {
        boolean isAllElementClickableTrue;
        commonFunctions.navigateToURL(globalVars.getURL());
        commonFunctions.mouseHoverOnElement(mobile,5,"mobile");
        commonFunctions.clickElement(mobileReviews);
    ...
    @Override
    public boolean checkMobileReviewsPageRHSAdsAreDisplayed() {
        commonFunctions.navigateToURL(globalVars.getURL());
        commonFunctions.mouseHoverOnElement(mobile,5,"mobile");
        commonFunctions.clickElement(mobileReviews);
        ...
        commonFunctions.scrollToElement(mobileComparison,"scrolled to mobileComparison");
