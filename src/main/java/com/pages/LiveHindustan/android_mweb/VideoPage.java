...
public class VideoPage extends CommonVideoPage {
    ...
    @FindBy(xpath = "(//div[@class='brd-crum']/a)[1]")
    ...
    @FindBy(xpath = "//div[@class='shre-innr']/a[contains(@class, 'wtsp-icn')]")
    ...
    public boolean checkSubmenuAreClickableOnVideoLandingPage() {
        ...
        boolean isAllElementClickableTrue = commonFunctionsMobileLH.isAllElementsClickableAndNavigatedToCorrectURL(videoL2Menu, videoL2MenuSize, videoUrl, "MenuValuesForRandomNumber");
    ...
    public boolean checkBreadcrumbRedirectionGiving200OnVideoWidget() {
        ...
        commonFunctions.isElementDisplayed(brdCrumList.get(0), 10, "Brd Crum List");
        String videoWeightUrl = commonFunctions.getCurrentURL();
        int videoBreadCrumSize = brdCrumList.size();
        boolean brdCrumStatus = commonFunctionsMobileLH.isAllElementsClickableAndGiving200Status(brdCrumList, videoBreadCrumSize, videoWeightUrl, brdCrumRedFirst, brdCrumRedSecound, brdCrumRedThird);
    ...
    public boolean checkVideoDetailPage() {
        ...
        commonFunctions.scrollDownToElement(videoPageMainTitles.get(0));
        commonFunctions.clickElementWithJS(videoPageMainTitles.get(0), 10, storyPageTitle);
        ...
        boolean isBreadCrumbContainsVideo = checkIfListContainsText(breadCrumbCurrentPage, LHConstants.VIDEO_HINDI);
    ...
    public boolean checkSambhanditVideoGalleryHavingFourVideosGiving200Status() {
        ...
        boolean isAllElementClickableTrue = commonFunctionsMobileLH.isAllElementsClickableAndNavigatedToCorrectURL(sambandhitWidget, videoSambandhitSize, videoWeightUrl, "WidgitValuesForRandomNumber");
    ...
    public boolean checkSocialSharingRedirectionAndGiving200OnVideoDetail() {
        ...
        //boolean whatsAppFlag = commonFunctionsMobileLH.validateSocialSharingIconFunctionality(socialSharingWhatsAppIcon, params.get("WhatsApp"), videoWeightUrl, "WhatsApp");
        boolean facebookFlag = commonFunctionsMobileLH.validateSocialSharingIconFunctionality(socialSharingFaceBookIcon, params.get("Facebook"), videoWeightUrl, "Facebook");
        boolean twitterFlag = commonFunctionsMobileLH.validateSocialSharingIconFunctionality(socialSharingTwitterIcon, params.get("Twitter"), videoWeightUrl, "Twitter");
        boolean hamefollowFlag = commonFunctionsMobileLH.validateSocialSharingIconFunctionality(socialSharingHameFollowIcon, params.get("HameFlowKare"), videoWeightUrl, "HameFlowKare");
    ...
    public boolean checkVideoIsPlayingSuccessfullyOnVideoDetailPage() {
        ...
        commonFunctions.clickElementWithJS(firstVideoWeight, 5, "First Video Weight");
        commonFunctions.isElementDisplayed(brdCrumFirst, 10, "Brd Crum List");
        boolean playerStatue = commonFunctionsMobileLH.validatePlayAndPauseButton(ytplayerFrame, videoState, player, "data-title-no-tooltip");
        return playerStatue;
    }
    ...
    public boolean checkVideoGalleryWidgetIsHaving5StoriesAndStatusIs200() {
        ...
        navigateToVideoPage();
        commonFunctions.dummyWait(5);
        return commonFunctionsMobileLH.isAllElementsClickableAndNavigatedToCorrectURL(videoGallerySection, videoGalleryLinks, videoGalleryWidgetSize, "WidgitValuesForRandomNumber");
    }
}
