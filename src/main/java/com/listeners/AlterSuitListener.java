...
public class AlterSuitListener implements IAlterSuiteListener {
    ...
    public void alter(List<XmlSuite> suites) {
        ...
        if(Strings.isNullOrEmpty(System.getProperty("environment")) && !parametersMap.isEmpty()){
    ...
    public static void setEnvironmentVariablesFromTextNGParameters(Map<String, String> parametersMap){
        ...
        if(!parametersMap.isEmpty()){
            ...
            globalVars.setIsBrowserStackLocal(parametersMap.get("isBrowserStackLocal"));
        }
    }
    ...
    public static void setEnvironmentVariablesFromMavenArguments(){
        ...
        globalVars.setIsBrowserStackLocal(System.getProperty("isBrowserStackLocal"));
    }
}
