...
public class HomePage extends CommonHomePage {
    ...
    @FindBy(xpath = "//div[@class='wdgt-lft']//a")
    ...
    @FindBy(xpath = "//div[@class='hdr-lft']/span/span")
    ...
    @FindBy(xpath = "//section[@id='track']/div[@id='home-de']/div/a")
    ...
    public boolean checkPramukhKhabreWidget() {
        return commonFunctionsMobile.pramukhKhabreWidget(allPramukhStoriesLink,sponsoredLink,"Android-MWeb");
    }
    ...
    public boolean checkTopNevBar() {
        ...
        commonFunctions.clickElementWithJS(hamburgerMenuButton, 10, "Hamburger menu");
        ...
        commonFunctions.clickElementWithJS(sheharChuneLink, 10, "शहर चुनें");
        ...
        commonFunctions.clickElementWithJS(closeSheharChune, 10, String.format("Close %s section button", LHConstants.SHEHAR_CHUNE_HINDI));
        boolean isEpaperLinkClickable = commonFunctions.isElementClickable(ePaperLink, 10, "ई-पेपर button");
        commonFunctions.clickElementWithJS(ePaperLink, 10, "ई-पेपर button");
        commonFunctions.dummyWait(5);
    ...
    public boolean checkAllPageAreLoadingProperly() {
        ...
        isAllPageAreLoadingProperlyTrue &= commonFunctions.getAttributeValue(getSelectedElement(topMenuOptions, LHConstants.HOME_HINDI), 10, "class").contains("active");

        clickElementWithGivenText(topMenuOptions, LHConstants.VIDEO_HINDI);
        isAllPageAreLoadingProperlyTrue &= commonFunctions.getElementText(pageBreadcrumb, 10).contains(LHConstants.VIDEO_HINDI);
        ...
        isAllPageAreLoadingProperlyTrue &= commonFunctions.getElementText(pageBreadcrumb, 10).contains(LHConstants.PHOTO_HINDI);
        ...
        isAllPageAreLoadingProperlyTrue &= commonFunctions.getElementText(pageBreadcrumb, 10).contains(LHConstants.GADGETS_HINDI);
    ...
    public boolean checkHomePageAndWidgets(){
        commonFunctions.navigateToURL(globalVars.getURL());
        commonFunctions.waitForPageToLoad();
        boolean isFirstAdDisplay = commonFunctions.isElementDisplayed(topAd, 15, "First Ad on the home page");
    ...
    /**
    * This function is made to be utilized by other overridden functions as per the requirement
     *
     * */
    ...
    public boolean checkWebStoryDetailPage() {
        commonFunctions.navigateToURL(globalVars.getURL());
        clickElementWithGivenText(allWidgetsLinksOnHomePage, LHConstants.WEB_STORY_HINDI);
        String urlBeforeWebStoryDetailPageOpen = commonFunctions.getCurrentURL();
        commonFunctions.clickElementWithJS(webStoriesPageAllTitles.get(0), 10, commonFunctions.getElementText(webStoriesPageAllTitles.get(0)));
        ArrayList<String> windowsList = new ArrayList<>(commonFunctions.getWindowHandlesWithExpectedNumberOfWindows(2));
        commonFunctions.switchToWindow(windowsList.get(windowsList.size() - 1));
    ...
    public boolean checkMwebHomePageRfuWidget(){
        ...
        boolean aapKeLiyaKhasStory = moveElementAndChechIsClickable(aapkeliyakhasStories);
        return aapKeLiyaKhasWidgit && aapKeLiyaKhasStory;
    }

    public boolean moveElementAndChechIsClickable(List<WebElement> list){
        boolean flag = false;
        for(int i=0;i<list.size();i++) {
            try {
                ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", list.get(i));
                commonFunctions.isElementClickable(list.get(i), 10, "Aap ke liya khas story");
                flag = true;
            }catch(Exception e){
                flag = false;
                break;
    ...
    public boolean checkAllTopicAreGiving200StatusCode() {
        commonFunctions.navigateToURL(globalVars.getURL());
        commonFunctions.dummyWait(5);
        return commonFunctionsMobile.isAllElementClickableAndReturns200(topicLinks, "TopicValuesForRandomNumber");
    }
    ...
    public boolean checkHTWidgetIsHaving6StoriesAndStatusIs200(){
        ...
        commonFunctions.navigateToURL(globalVars.getURL());
        commonFunctions.dummyWait(5);
        return commonFunctionsMobile.isAllElementsClickableAndNavigatedToCorrectURL(HTSection,HTStorySection,HTStoriesSize, "WidgitValuesForRandomNumber");
    }
    ...
    public boolean checkLMWidgetIsHaving6StoriesAndStatusIs200(){
        ...
        commonFunctions.navigateToURL(globalVars.getURL());
        commonFunctions.dummyWait(5);
        return commonFunctionsMobile.isAllElementsClickableAndNavigatedToCorrectURL(LMSection,LMStorySection,LMStoriesSize, "WidgitValuesForRandomNumber");
    }
    ...
    public boolean checkNewsBriefWidgetIsHaving7StoriesAndStatusIs200() {
        ...
        commonFunctions.navigateToURL(globalVars.getURL());
        commonFunctions.dummyWait(5);
        return commonFunctionsMobile.isAllElementsClickableAndNavigatedToCorrectURL(newsBriefSection,newsBriefStoriesLink,newsBriefStoriesSize, "WidgitValuesForRandomNumber");
    }
