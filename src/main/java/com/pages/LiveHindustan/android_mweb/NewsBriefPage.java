...
public class NewsBriefPage extends CommonNewsBriefPage {
    ...
    public boolean checkWhileSwipingTheStoriesUrlShouldChange(){
        ...
        for(int i = startingPoint; i < catSize; i = i+increasingPoint){
            ...
            for(int k =0;k<5;k++) {
                commonFunctions.swipeElementUsingTouchAction(0, 2000, 0, 0);
            }
            commonFunctions.dummyWait(5);
            String storyUrl = commonFunctions.getCurrentURL();
    ...
    public boolean checkSocialSharingRedirectionOnNewsBriefPage(){
        ...
        //boolean whatsAppFlag = commonFunctionsMobile.validateSocialSharingIconFunctionality(whatsAppNewsBref, params.get("WhatsApp"), newsBriefUrl, "WhatsApp");
        boolean facebookFlag = commonFunctionsMobile.validateSocialSharingIconFunctionality(facebookNewsBref, params.get("Facebook"), newsBriefUrl, "Facebook");
        boolean twitterFlag = commonFunctionsMobile.validateSocialSharingIconFunctionality(twitterNewsBref, params.get("Twitter"), newsBriefUrl, "Twitter");
