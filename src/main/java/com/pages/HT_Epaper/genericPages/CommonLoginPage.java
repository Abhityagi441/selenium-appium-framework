package com.pages.HT_Epaper.genericPages;
        ...
        if(commonLoginPage==null || !globalVars.getIsLastTestCasePass()){
            switch (globalVars.getPlatformName()){
                ...
                case Constants.DESKTOP_WEB:
                    commonLoginPage= new com.pages.HT_Epaper.DesktopBrowserPages.LoginPage();
                    break;
                case Constants.ANDROID_AMP:
                case Constants.IOS_AMP:
                case Constants.ANDROID_WEB:
                    commonLoginPage= new com.pages.HT_Epaper.AndroidWebPages.LoginPage();
                    break;
                case Constants.IOS_WEB:
                    commonLoginPage= new com.pages.HT_Epaper.IOSWebPages.LoginPage();
                    break;
