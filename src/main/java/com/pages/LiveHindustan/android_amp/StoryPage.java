...
public class StoryPage extends CommonStoryPage {
    ...
    @FindBy(xpath = "(//div[@class='rlt-listimg']//img)[1]")
    ...
    @FindBy(xpath = "//a[@class='shr-button gnws']")
    ...
    @Override
    public boolean checkListViewInSambahanditKhabreWidgetInStoryPages() {return false;}
    ...
    public boolean checkSocialSharingRedirectionOnStoryDetailPage()
    {
        ...
        try {
            ...
            commonFunctions.closeAllWindowsExceptMasterTab();
            commonFunctions.scrollToElement(followUsAmp, 10, "Follow Us");
            commonFunctions.clickElementWithJS(followUsAmp, 10, "Follow Us");
            commonFunctions.dummyWait(5);
